...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            ...
            <form:errors path="unityInStock" cssStyle="color: #ff0000;"/>
            <form:input path="unityInStock" id="unityInStock" class="form-control"/>
        </div>

        <div class="form-group">
            <label for="manafacturer">Manafacturer</label>
            <form:input path="productManufacturer" id="manafacturer" class="form-control"/>
        </div>
